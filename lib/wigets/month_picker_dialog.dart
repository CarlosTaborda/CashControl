...
class _MonthPickerDialogState extends State<_MonthPickerDialog> {
  ...
  Widget _getMonthButton(
    ...
    return ElevatedButton(
      onPressed: callback,
      style: ButtonStyle(
        backgroundColor: MaterialStateProperty.all<Color>(date.month == selectedDate.month && date.year == selectedDate.year
          ? theme.accentColor
          : null),
  ...
  Widget _getYearButton(int year, ThemeData theme, String locale) {
    return ElevatedButton(
      ...
      style: ButtonStyle(
        backgroundColor: MaterialStateProperty.all<Color>(year == selectedDate.year ? theme.accentColor : null),
      ),
      child: Text(
